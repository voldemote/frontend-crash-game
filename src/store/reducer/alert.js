...
export default function (state = initialState, action) {
    switch (action.type) {
        ...
        case AlertTypes.REMOVE_ALL:   return removeAll(action, state);
        case AlertTypes.REMOVE:       return remove(action, state);
        case AlertTypes.SHOW_ERROR:
        case AlertTypes.SHOW_SUCCESS: return showResult(action, state);
