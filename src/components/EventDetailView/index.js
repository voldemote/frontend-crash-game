...
const EventDetailView = ({ event, isAdmin }) => {
    ...
    const renderEventDetails = () => {
        ...
        const eventStartDate        = moment(_.get(event, 'date', null)).format(dateFormat);
        const eventEndDate          = moment(_.get(event, 'endDate', eventStartDate)).format(dateFormat);
        const eventState            = _.get(event, 'state', 'active');
        const summaryRows           = [
            BetSummaryHelper.getKeyValue('Event Creator', eventCreator),
            BetSummaryHelper.getKeyValue('Name of the Event', eventTitle, false, true),
            ...
            BetSummaryHelper.getKeyValue('Event Feed Source', eventFeedSource, false, false, false, null, true),
            BetSummaryHelper.getKeyValue('User Permission to Create Trades', tradeCreatePermission),
            BetSummaryHelper.getKeyValue(
                'Start Date',
                null,
                false,
