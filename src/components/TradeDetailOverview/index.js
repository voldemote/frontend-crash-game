...
const TradeDetailOverview = ({ className, hidePopup, showPopup, event, trade }) => {
        ...
        return (
            <div className={styles.tradeDetailOverviewContent}>
                ...
                <div className={styles.linkContent}>
                    <span onClick={onSeeDetailsClick}>
                        See Details
                    </span>
                    <span onClick={onGoToTradeClick}>
                        Go to Trade
                    </span>
                </div>
            </div>
