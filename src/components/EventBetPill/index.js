  ...
  return (
    <div className={styles.pill} onClick={onClick}>
      <div className={styles.pillContent}>
        ...
        <div className={styles.justify} onClick={ClickEvent.stopPropagation}>
          ...
          <Button
            ...
            onClick={onConfirm}
          >
            <span className={styles.buttonContent}>Trade!</span>
          </Button>
        </div>
      </div>
      {renderFooter()}
...
const mapStateToProps = (state, ownProps) => {
  ...
  if (bet) {
    outcomes = _.get(state.bet.outcomes, bet._id);
...
export default connect(mapStateToProps, mapDispatchToProps)(EventBetPill);
