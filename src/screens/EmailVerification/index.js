...
const EmailVerification = ({ emailVerificationState, verifyEmail, showPopup }) => {
            ...
            <div className={styles.emailVerificationContainer}>
                ...
                >
                    ...
                    <span className={styles.shortcutText}>
                        Verification {emailVerificationState === true ? 'was successful' : emailVerificationState === false ? 'has failed' : 'is running'}.
                    </span>
