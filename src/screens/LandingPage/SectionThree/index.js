    ...
    <section className={classes.section}>
      ...
      <div className={classes.textContainer}>
        ...
        <p className={classes.textParagraph}>
          When you sign up to Wallfair Alpha, not only do you receive 5,000 play
          money
          ...
          are thinking “How can I win that real money, how can I get those WFAIR
          tokens?” It’s easy, at the end of each week and month, we will reward
          our highest performing players with up to 20k in WFAIR that can of
