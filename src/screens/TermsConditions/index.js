    ...
    <BaseContainerWithNavbar withPaddingTop={true}>
      <div className={styles.container}>
       ...
       <div className={styles.textContainer}>
          ...
          <p>8.2. Fees and charges may apply to customer deposits and withdrawals, which can be found on the Website. In most cases we absorb transaction fees for deposits to your alpacasino.io Account. You are responsible for your own bank charges that you may incur due to depositing funds with us.</p>
          ...
          <p>
            ...
            In order for you to register and be eligible for our Affiliate program you need to sign up at the Alpacasino site and place at least one bet. </p>
          ...
          <p>12.5. It is your responsibility to regularly check the General Bonus Terms and Conditions and these Terms for any changes or updates. If these Terms and General Bonus Terms and Conditions are changed, Alpacasino will inform you.</p>
          ...
          <p>12.7. Alpacasino reserves the right to suspend or close Accounts suspected of being duplicate. The player's original deposit, if any, will not be confiscated and only the Promotions and/or winnings resulting from the Promotions will be confiscated.</p>
          ...
          <p>12.17. Alpacasino Promotions are intended for recreational play only. Improper use of Promotions and Promotion abuse will not be tolerated. We reserve the right to take the following actions against Promotion abuse (list not exhaustive).</p>
          <p>
            <ul>
          ...
          <p>
            <ul>
              ...
              <li>Evidence of an attempt to defraud or take unfair advantage of the Alpacasino and its Promotions by an individual or group</li>
          ...
          <p>12.22. Promotion money is free credit that you can use to enjoy Alpacasino. It may not be withdrawn after it has been received unless you have met the conditions under which it was given. To prevent you from withdrawing your bonus money immediately, Alpacasino requires the so-called "wagering" of the Promotion credit. The wagering coefficient indicates how many times you have to place the Promotion amount to unlock the Promotion.</p>
          ...
          <p>12.43. The Welcome Bonus Promotion (“WBP”) is available to new players who create an Alpacasino Account.</p>

          <p>12.44. Players making their first deposit on Alpacasino are eligible to receive this Promotion. The WBP offer currently consists of a deposit bonus of 100% up to 25.000 WFair Token credits on your first deposit.</p>

          <p>12.45. This welcome bonus is only available for new Accounts at Alpacasino.</p>
