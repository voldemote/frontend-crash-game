    ...
    <div>
      <BaseContainerWithNavbar withPaddingTop={true}>
        ...
        <LegalText>
          ...
          <p>
            We, Wallfair.io (Rosi Development GmbH), are delighted that you have
            shown interest in our enterprise. Data protection is of a
            particularly high priority for the management of Wallfair. Our
            transparency document according to Art. 13 and 14 GDPR is available
            upon request.
          </p>
          <p>
          ...
          <p>
            ...
            applicable. By means of this data protection declaration, our
          ...
          <p>
            As a data Controller, Wallfair has implemented numerous technical
          ...
          This data protection declaration is based on the terms used by the
          European legislator for the adoption of the General Data Protection
          Regulation (GDPR). It is prepared to be legible and understandable for
          the general public, as well as our customers and business partners. To
          ensure this, we would like to first explain the terminology used. In
          ...
          Rosi Development GmbH Weidenbornstrasse 8a 65189 Wiesbaden Germany
          <br />
          Email: <a href="mailto:hello@wallfair.io">hello@wallfair.io</a>
          <br />
          Website: <a href="http://www.joinwallfair.io">www.joinwallfair.io</a>
          <br />
          <strong>3 Name and Address of the Data Protection Officer</strong>
          The data protection officer of the Controller is Prof. Dr. Sebastian
          Gajek, Email:{' '}
          <a href="mailto:privacy@wallfair.io">privacy@wallfair.io</a>. Any data
          ...
          <p>
            {' '}
            Our website uses cookies, text files that are stored in a computer
            system via an internet browser. Many Internet sites and servers use
            cookies. Many cookies contain a so-called cookie ID. A cookie ID is
            a unique identifier of the cookie. It consists of a character string
            ...
            individual browser of the data subject from other Internet browsers
            that contain other cookies. A specific Internet browser can be
            recognized and identified using the unique cookie ID.
          </p>
          <p>
            Through the use of cookies, Wallfair can provide the users of this
          ...
          <p>
            Our website collects a series of general data and information when a
            data subject or automated system calls up the website. This general
            data and information are stored in the server log files. Collected
            may be (1) the browser types and versions used, (2) the operating
          ...
          <p>
            ...
            in case of a cyber-attack. Therefore, we analyze anonymously
            collected data and information statistically with the help of Google
            Analytics, Yandex Metrica and Hotjar, with the aim of increasing the
            ...
            all personal data provided by a data subject. You have the option to
            familiarize yourselves with the Privacy Policies of the service
            providers under the following links:
          </p>
          <p>
            <a href="https://policies.google.com/privacy?hl=en-US https://yandex.com/support/metrica/general/gdpr.html">
          ...
          <p>
            ...
            the Controller with the indication of personal data. The personal
            data transmitted to the Controller is determined by the respective
            input mask used for the registration. The personal data entered by
            the data subject are collected and stored exclusively for internal
            use by the Controller, and for his own purposes. The Controller may
            request transfer to one or more processors (e.g. a parcel service)
          ...
          <p>
            ...
            Our Data Protection Officer is available to the data subject as
            contact persons.
          </p>
          <strong>
          ...
          <ol>
            <li>
              <strong> Right of confirmation</strong>
            ...
            <li>
              ...
              <p>
                ...
                Wallfair, he or she may, at any time, contact any employee of
                the Controller. Our employees shall promptly ensure that the
              ...
              <p>
                ...
                those personal data, as far as processing is not required.
              </p>
            </li>
            <li>
              ...
              data stored by us, he or she may at any time contact any employee
              of the Controller who will then arrange for. the restriction of
              the processing.
            </li>
            <li>
            ...
            <li>
              ...
              <p>
                {' '}
                If we process personal data for direct marketing purposes, the
                ...
                the processing for direct marketing purposes, we shall no longer
              ...
              <p>
                ...
                personal data concerning him or her by us for scientific or
              ...
              <p>
                ...
                contact our Data Protection Officer. In addition, the data
            ...
            <li>
              ...
              <p>
                ...
                authorized by Union or Member State law to which the Controller
              ...
              <p>
                ...
                consent, Wallfair shall implement suitable measures to safeguard
            ...
            <li>
              ...
              <p>
                ...
                consent, he or she may, at any time, contact our Data Protection
                Officer.
              </p>
            </li>
          </ol>
          ...
          <strong>
            10 Data Protection Provisions for about the Application and Use of
            Google Analytics
          </strong>
          <p>
          ...
          <p>
            ...
            abridged by Google and anonymized when accessing our websites from a
          ...
          <strong>
            11 Data Protection Provisions concerning the Application and Use of
            Social Media
          </strong>
          On this website, the Controller has integrated components of LinkedIn,
          Twitter and Telegram. With each call-up to one of the individual pages
          of this website, which is operated by the Controller and on which a
          social media component was integrated, the internet browser on the
          information technology system of the data subject is automatically
          prompted to download a display of the corresponding social media
          component. During the course of this technical procedure, the above-
          mentioned social media websites and Google gain knowledge of what
          ...
          <p>
            ...
            of the above mentioned legal grounds, if processing is necessary for
            ...
            client of the Controller (Recital 47 Sentence 2 GDPR). Where the
            processing of personal data is based on Article 6(1) lit. f GDPR our
            legitimate interest is to carry out our business in favor of the
          ...
          <p>
            {' '}
            We would like to clarify that the provision of personal data is
            ...
            could not be concluded. Before personal data is provided by the data
            ...
            the personal data. In addition, we do not use automatic
