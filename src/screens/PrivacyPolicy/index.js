    ...
    <BaseContainerWithNavbar withPaddingTop={true}>
      <div className={styles.container}>
       ...
       <div className={styles.textContainer}>
          ...
          <h2>Overview</h2>
          <p>
            We, Alpacasino.io (Wallfair N.V.), are delighted that you have shown interest in our
            enterprise. Data protection is of a particularly high priority for the management of Alpacasino.
            Our transparency document according to Art. 13 and 14 GDPR is available upon request.
            The use of the website is possible without any indication of personal data; however, if a data
            ...
            statutory basis for such processing, we generally obtain consent from the data subject.<br /><br />
            ...
            By means of this data protection declaration, our enterprise would like to inform the general
            ...
            rights to which they are entitled.<br /><br />
            As a data Controller, Alpacasino has implemented numerous technical and organizational
          ...
          <h2>1 Definitions</h2>
          <p>
            This data protection declaration is based on the terms used by the European legislator for the
            adoption of the General Data Protection Regulation (GDPR). It is prepared to be legible and
          ...
          <p>
            ...
            <a href="mailto:privacy@alpacasino.io">privacy@alpacasino.io</a>
          ...
          <p>
            ...
            specific Internet browser can be recognized and identified using the unique cookie ID.<br /><br />
            Through the use of cookies, Alpacasino can provide the users of this website with more
            user-friendly services that would not be possible without the cookie setting.<br /><br />
          ...
          <p>
            ...
            case of a cyber-attack. Therefore, we analyze anonymously collected data and information
            statistically with the help of Google Analytics, Yandex Metrica and Hotjar, with the aim of
            ...
            files are stored separately from all personal data provided by a data subject. You have the
            option to familiarize yourselves with the Privacy Policies of the service providers under the
            following links:
          ...
          <p>
            ...
            indication of personal data. The personal data transmitted to the Controller is determined by
            the respective input mask used for the registration. The personal data entered by the data
            ...
            service) that also uses personal data for an internal purpose which is attributable to the
            Controller.<br /><br />
            ...
            pass on the data, or if the transfer serves the aim of criminal prosecution.<br /><br />
            ...
            offered to registered users due to the nature of the matter in question. Registered persons
            are free to change the personal data specified during the registration at any time, or to have
            them completely deleted from the data stock of the Controller.<br /><br />
            ...
            shall correct or erase personal data at the request or indication of the data subject, insofar as
            there are no statutory storage obligations. Our Data Protection Officer is available to the data
            subject as contact persons.
          </p>

          <h2>7 Routine Erasure or Restriction of Processing of Personal Data</h2>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              the significance and envisaged consequences of such processing for
              the data subject.<br /><br />
              ...
              relating to the transfer.<br /><br />
          ...
          <p>
            ...
            restriction of the processing of personal data stored by us, he or she may at any time contact
            any employee of the Controller who will then arrange for. the restriction of the processing.
          </p>
          ...
          <p>
            ...
            <br /><br />
            In order to assert the right to data portability, the data subject may at any time contact our
          ...
          <p>
            ...
            the data subject objects to the processing for direct marketing purposes, we shall no longer
            ...
            <br /><br />
            In order to exercise the right to object, the data subject may contact our Data Protection
            Officer. In addition, the data subject is free in the context of the use of information society
          ...
          <p>
            ...
            the data subject and a data Controller, or (2) is not authorized by Union or Member State law
            ...
            decision-making, he or she may, at any time, contact our Data Protection Officer.
          </p>
          ...
          <p>
            ...
            her consent to processing of his or her personal data at any time.<br /><br />
            If the data subject wishes to exercise the right to withdraw the consent, he or she may, at any
            time, contact our Data Protection Officer.
          </p>

          <h2>9 Data Protection for Applications and Application Procedures</h2>
          <p>
          ...
          <h2>10 Data Protection Provisions for about the Application and Use of Google Analytics</h2>
          <p>
            ...
            order to carry out a cost-benefit analysis of Internet advertising.<br /><br />
            The operator of the Google Analytics component is Google Ireland Limited, Gordon House,
            Barrow Street, Dublin, D04 E5W5, Ireland.<br /><br />
            ...
            data subject is abridged by Google and anonymized when accessing our websites from a
            Member State of the European Union or another Contracting State to the Agreement on the
            European Economic Area.<br /><br />
            ...
            services concerning the use of our Internet site for us.<br /><br />
            ...
            may pass these personal data collected through the technical procedure to third parties.<br /><br />
            ...
            deleted at any time via a web browser or other software programs.<br /><br />
            ...
            <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noreferrer">https://tools.google.com/dlpage/gaoptout</a>
             and install it. This browser add-on tells Google
            ...
            it is possible to execute the reinstallation or reactivation of the browser add-ons.<br /><br />
            Further information and the applicable data protection provisions of Google may be retrieved under<br/><br/>
            <a href="https://www.google.com/intl/en/policies/privacy/" target="_blank" rel="noreferrer">https://www.google.com/intl/en/policies/privacy/</a> and under<br /><br />
            <a href="http://www.google.com/analytics/terms/us.html" target="_blank" rel="noreferrer">http://www.google.com/analytics/terms/us.html</a>.<br /><br />
            Google Analytics is further explained under the following link:<br />
            <a href="https://www.google.com/analytics/." target="_blank" rel="noreferrer">https://www.google.com/analytics/</a>.
          </p>

          <h2>11 Data Protection Provisions concerning the Application and Use of Social Media</h2>
          <p>
            ...
            Controller and on which a social media component was integrated, the internet browser on
            the information technology system of the data subject is automatically prompted to download
            a display of the corresponding social media component. During the course of this technical
            procedure, the above-mentioned social media websites and Google gain knowledge of what
          ...
          <p>
            ...
            client of the Controller (Recital 47 Sentence 2 GDPR). Where the processing of personal
            data is based on Article 6(1) lit. f GDPR our legitimate interest is to carry out our business in
            favor of the well-being of all our employees and the shareholders
          </p>

          <h2>13 Period of storage of personal data</h2>
          <p>
            ...
            of a contract.<br /><br />
            We would like to clarify that the provision of personal data is partly required by law (e.g. tax
            regulations) or can also result from contractual provisions (e.g. information on the contractual
            partner). Sometimes it may be necessary to conclude a contract that the data subject
            provides us with personal data, which must subsequently be processed by us. The data
            ...
            provide the personal data and the consequences of non-provision of the personal data. In
            addition, we do not use automatic decision-making or profiling.
          </p>
        </div>        
      </div>
